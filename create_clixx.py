...
def delete_network_interfaces(subnet_id):
    """Delete network interfaces within the subnet to prevent DependencyViolation errors."""
    ...
    for eni in enis['NetworkInterfaces']:
        ...
        try:
            ...
            continue  # Continue with the next ENI if there’s an error

def delete_subnets(vpc_id):
    """Delete subnets within a VPC, handling network interfaces to prevent dependencies."""
